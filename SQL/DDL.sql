...
(
    ...
    CONSTRAINT FK_ex_eq FOREIGN KEY (exercise_equipment)
...
(
    ...
    CONSTRAINT FK_WP_DP FOREIGN KEY (Diet_id)
    REFERENCES Diet_Plan(Diet_id);
);
...
(
    ...
    CONSTRAINT FK_MW_MG FOREIGN KEY (muscle_group)
    REFERENCES Muscle_group(muscle_group);
);
