...
<html>
    ...
    $q = "INSERT INTO Member (M_password,Age,gender)
    VALUES (".$_POST["M_password"].", ".$_POST["Age"].", ".$_POST["Gender"].")";
    $query_id = oci_parse($con, $q); 		
    $r = oci_execute($query_id);
    echo"<br>";
    echo"Your Record has been Inserted Successfully.Now you are Member of FITME";
    }
 ?>
    </body>
</html>